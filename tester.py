...
f = open('./tests/results/out1-extended.txt', 'w')
sys.stdout = f

FILEPATH_PREFIX = './tests/'
for file in ['test.csv', 'test1.csv', 'test2.csv', 'test3.csv', 'test4.csv', 'test5.csv', 'test6.csv', 'test7.csv', 'gs_test1.csv', 'gs_test2.csv']:
